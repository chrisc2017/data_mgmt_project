...
CREATE TABLE re1_department (
    name                VARCHAR2(256),
    mission_statement   VARCHAR2(4000),
...
ALTER TABLE re1_executes ADD CONSTRAINT executes_pk PRIMARY KEY ( project_project_id,
task_task_id );
...
CREATE TABLE re1_person (
    ...
    contract                   BLOB,
    cv                         VARCHAR2(4000),
    terminating_reason         VARCHAR2(256),
    leave_status               VARCHAR2(256),
    last_day                   DATE,
    id                         INTEGER,
    hire_date                  DATE,
    salary                     NUMBER(34,2),
...
ALTER TABLE re1_person
    ADD CONSTRAINT re1_person_exdep CHECK (
        (
            ...
            AND salary IS NULL
            AND title IS NULL
            AND terminating_reason IS NULL
...
ALTER TABLE re1_executes
    ADD CONSTRAINT executes_project_fk FOREIGN KEY ( project_project_id )
        REFERENCES re1_project ( project_id );

ALTER TABLE re1_executes
    ADD CONSTRAINT executes_task_fk FOREIGN KEY ( task_task_id )
